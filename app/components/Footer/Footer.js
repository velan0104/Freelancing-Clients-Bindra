...
const Footer = () => {
    return (
        <footer className=' w-full mx-auto bg-[#daa520]/50 py-10 md:flex-row gap-y-10'>
                    ...
                    <div>
                        {
                            ["Our Story", "Our Impact", "Careers", "Investor Relation", "All Projects", "Grievance Portal"].map((item, index) => (
                                <h1 key={index} className='text-gray-900 font-semibold hover:font-bold cursor-pointer'> {item} </h1>
                            ))
                        }
                    </div>
                    <div>
